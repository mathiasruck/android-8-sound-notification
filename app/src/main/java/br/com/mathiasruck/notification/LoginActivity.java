...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public void createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            CharSequence name = getString(R.string.notification_channel_01);
            String description = getString(R.string.notification_channel_description_01);
            int importance = NotificationManager.IMPORTANCE_HIGH;
            NotificationChannel channel = new NotificationChannel(MathiasruckFcmHandler.CHANNEL_ID, name, importance);
            ...
            Uri uri = Uri.parse("android.resource://" + this.getPackageName() + "/" + R.raw.police_siren_sound);
